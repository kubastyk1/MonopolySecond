...
public class NormalFieldTest {
	...
	@Test
	public void addMoneyOnStartTest() throws Exception{

		Dice dice = new Dice(10, 6, 0);
		roomController.addingNumbers(dice);

		Assert.assertEquals(16, player0.getPosition());
		Assert.assertEquals(1500, player0.getMoney());

		dice = new Dice(30, 8, 0);
		roomController.addingNumbers(dice);

		Assert.assertEquals(14, player0.getPosition());
		Assert.assertEquals(1700, player0.getMoney());

		dice = new Dice(30, 6, 0);
		roomController.addingNumbers(dice);

		Assert.assertEquals(10, player0.getPosition());
		Assert.assertEquals(1900, player0.getMoney());
